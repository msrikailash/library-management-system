...
urlpatterns = [
    ...
    path('reserve/<int:pk>/', views.reserve_book_view, name='reserve_book'),
    path('my-reservations/', views.my_reservations_view, name='my_reservations'),
    path('reservations/cancel/<int:pk>/', views.cancel_reservation_view, name='cancel_reservation'),
    path('reservations/manage/', views.manage_reservations_view, name='manage_reservations'),
